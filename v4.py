...
class SmartWeighingScale:
    def __init__(self, master):
        ...
        self.create_style()
        # self.create_main_window() # Main window creation is now conditional
    ...
    def check_license(self):
        ...
        if result:
            ...
            if current_date > expiry_date:
                ...
                # License is valid, proceed with normal operation
                self.create_main_window()
        else:
            # No license key found, prompt for one
    ...
    def create_database(self):
        ...
        if self.cursor.fetchone()[0] == 0:
            ...
            self.cursor.execute("INSERT INTO license_keys (license_key, expiry_date) VALUES (?, ?)",
                                ("LICENSE_KEY_AFTER_AUG_2025", "2099-12-31")) # A far future date
        self.conn.commit()
